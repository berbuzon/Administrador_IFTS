        ...
        if ($stmt_dp->execute()) {
            ...
            if ($stmt_ad->execute()) {
                ...
                if ($stmt_form->execute()) {
                    $mensaje = "✅ Adolescente agregado correctamente.";
                } else {
                    $mensaje = "❌ Error al crear formulario: " . $conexion->error;
                }
            } else {
                $mensaje = "❌ Error al crear adolescente: " . $conexion->error;
            }
        } else {
            $mensaje = "❌ Error al crear datos personales: " . $conexion->error;
        }
    } else {
